    ...
    return (
        <View style={{ flex: 1 }}>
            ...
            <Tab.Navigator  tabBarPosition='bottom' screenOptions={{swipeEnabled:false,tabBarStyle:{height:60}, animationEnabled:false }}>
                ...
                <Tab.Screen name="cart" options={{tabBarIcon:({focused, color})=>(focused? <Entypo name="shopping-cart" size={24} color="black" />: <AntDesign name="shopping-cart" size={24} color="black"  /> ), title:'Cart'}} component={CartScreen} />
